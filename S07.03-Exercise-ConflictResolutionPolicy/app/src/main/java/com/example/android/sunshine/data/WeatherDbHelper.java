...
//  TODODONE (2) Increment the database version after changing the create table statement
    /*
...
//              TODODONE (1) Add a UNIQUE constraint on the date column to replace on conflict
