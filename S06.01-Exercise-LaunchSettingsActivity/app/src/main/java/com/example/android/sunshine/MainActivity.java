...
public class MainActivity extends AppCompatActivity implements
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // TODODONE (1) Add new Activity called SettingsActivity using Android Studio wizard
        // Do step 2 in SettingsActivity
        // TODODONE (2) Set setDisplayHomeAsUpEnabled to true on the support ActionBar

        // TODODONE (6) Launch SettingsActivity when the Settings option is clicked
