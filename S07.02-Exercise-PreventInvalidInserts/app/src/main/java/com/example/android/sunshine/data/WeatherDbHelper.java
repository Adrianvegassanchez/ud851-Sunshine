...
//  TODODONE (2) Increment the database version after altering the behavior of the table
    /*
...
//              TODODONE (1) Append NOT NULL to each column's type declaration except for the _ID
                /*
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        // TODODONE (3) Within onUpgrade, drop the weather table if it exists
        // TODODONE (4) call onCreate and pass in the SQLiteDatabase (passed in to onUpgrade)
